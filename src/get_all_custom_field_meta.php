...
if ( ! function_exists( 'get_all_custom_field_meta' ) ) :
	 ...
	 *
	 * @param int|string $object_id      Required. Post ID, 'option', or 'term_{id}'.
	 ...
	 * @return array
	 */
	function get_all_custom_field_meta( $object_id, array $config, array $clone_fields = [], $include_labels = false ): array {
		...
		$field_group_values = new \TimJensen\ACF\Field_Group_Values( $object_id, $config, $clone_fields, $include_labels );
