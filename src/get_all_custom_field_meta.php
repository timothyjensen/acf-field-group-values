...
if ( ! function_exists( 'get_all_custom_field_meta' ) ) :
	 ...
	 * @return array
	 */
	function get_all_custom_field_meta( $post_id, array $config, array $clone_fields = [], $include_labels = false ): array {
		...
		$field_group_values = new \TimJensen\ACF\Field_Group_Values( $post_id, $config, $clone_fields, $include_labels );
